        ...
        <el-page-header class="p-10">
            ...
            <template #content>
                <div class="flex items-center">
                    ...
                    />
                    <span class="text-large font-600 mr-3"> 页面孵化中 </span>
            ...
            <p class="mt-4 text-sm">
                Element Plus team uses <b>weekly</b> release strategy under normal circumstance, but critical bug fixes
                would require hotfix so the actual release number <b>could be</b> more than 1 per week.
            </p> -->
        </el-page-header>
    </div>
</template>
